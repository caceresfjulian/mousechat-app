...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        if (!email || !password || !passwordVerify || !base64) {
            ...
            return res
                .status(400)
                .json({ mensajeError: "Por favor ingrese todos los datos requeridos." });
        }
        ...
        if (password.length < 6) {
            ...
            return res
                .status(400)
                .json({ mensajeError: "Por favor ingrese una contraseña de mínimo 6 caracteres." });
        }
        ...
        if (password !== passwordVerify) {
            ...
            return res
                .status(400)
                .json({ mensajeError: "Por favor ingrese la misma contraseña dos veces." })
        }
...
router.post('/login', async (req, res) => {
    ...
    try {
        ...
        const passwordCorrecto = await bcrypt.compare(password, usuarioExistente.passwordHash);
